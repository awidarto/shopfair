...
class Shop_Controller extends Base_Controller {
	...
	*/
	...
	public function get_deals()
	{
		...
		$deals1 = $products->find(array('section'=>'deals','category'=>'6column'),array(),array('createdDate'=>-1),$limit);
		$deals2 = $products->find(array('section'=>'deals','category'=>'4column'),array(),array('createdDate'=>-1),$limit);
		$deals3 = $products->find(array('section'=>'deals','category'=>'2column'),array(),array('createdDate'=>-1),$limit);
