...
class Sponsors_Controller extends Admin_Controller {
	...
	public function get_index()
	{
		...
		$this->heads = array(
			...
			array('Section',array('search'=>true,'sort'=>true,'select'=>Config::get('content.sponsors.sections'))),
			array('Category',array('search'=>true,'sort'=>true,'select'=>Config::get('content.sponsors.categories'))),
	...
	public function namePic($data){
		$name = HTML::link('sponsors/view/'.$data['_id'],$data['title']);
